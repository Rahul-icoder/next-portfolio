    ...
    <div className="flex relative z-10 justify-center px-6 sm:px-10 py-13">
      <div className="flex items-center gap-10 md:flex-row flex-col">
        <div className="flex flex-col justify-start items-center">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl tracking-wide my-6 text-center text-gray-900">
            Hi, I&#x27;m <span>Rahul</span> 👋
          </h1>
          <h2 className="text-xl md:text-2xl lg:text-3xl text-gray-500 mx-auto text-gray-900 text-center">
          ...
          <div className="flex mt-12 gap-1 ">
            ...
            >
              <div
                className="footer-icon h-32 w-32"
          ...
          <div className="flex justify-center mt-10">
            <a href="resume.pdf" target="_blank" rel="noreferrer">
              <button className="text-sm p-3 sm:p-4 text-white tracking-wider hover:bg-white hover:text-purple-900 transition duration-500 border border-purple-900 p-2 bg-purple-900">
                DOWNLOAD RESUME
              </button>
            </a>
          </div>
