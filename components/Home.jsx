...
function Home() {
	return (
		 <div style={{height:'80%'}} className="flex relative z-20 items-center">
		        <div className="container mx-auto px-6 flex flex-col justify-between items-center relative py-4">
		            <div className="flex flex-col">
		                ...
		                <h2 className="max-w-3xl text-3xl md:text-5xl lg:text-6xl font-bold mx-auto text-white text-center">
